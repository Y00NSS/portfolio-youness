  ...
  return (
    <div className="relative flex flex-col-reverse ">
      <div className="flex flex-col gap-3 rounded-md bg-background sm:p-0  p-5 sm:mt-0 mt-52 pt-3 sm:mb-0 sm:pt-0 sm:pb-0 sm:bg-transparent">
        ...
        <p className="animate-fade-left font-medium text-2xl sm:text-4xl">
          {title_description}
        </p>
      ...
      <div>
        <Image
          ...
          width={900}
          height={1200}
          className="animate-fade-right absolute right-0 -top-4 w-[28rem] sm:right-0 sm:-top-10 h-auto sm:w-[34rem] -z-10 object-contain"
